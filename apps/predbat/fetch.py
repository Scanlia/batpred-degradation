...
class Fetch:
    ...
    def fetch_sensor_data(self, save=True):
        ...
        if self.rate_import:
            ...
            self.rate_import_base, _ = self.rate_replicate(self.rate_import.copy(), {}, is_import=True, history_buckets=history_buckets_import)  # True import rates, gap-filled but without IO/saving/override distortion
