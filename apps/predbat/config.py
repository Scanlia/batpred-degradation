...
CONFIG_ITEMS = [
    ...
    {
        "name": "degradation_enable",
        "friendly_name": "Degradation Model Enable",
        "type": "switch",
        "enable": "expert_mode",
        "default": False,
    },
    {
        "name": "degradation_chemistry",
        "friendly_name": "Degradation Battery Chemistry",
        "type": "select",
        "options": ["LFP", "NMC", "SODIUM_ION", "NCA", "LEAD_ACID", "FLOW"],
        "enable": "expert_mode",
        "default": "LFP",
    },
    {
        "name": "degradation_capex",
        "friendly_name": "Degradation Battery Capital Cost",
        "type": "input_number",
        "min": 0,
        "max": 5000000,
        "step": 10000,
    ...
    {
        "name": "degradation_lifetime_cycles",
        "friendly_name": "Degradation Rated Lifetime Cycles",
        "type": "input_number",
        "min": 100,
        "max": 50000,
        "step": 100,
    ...
    {
        "name": "degradation_battery_capacity",
        "friendly_name": "Degradation Battery Capacity",
        "type": "input_number",
        "min": 1,
        "max": 200,
        "step": 0.1,
